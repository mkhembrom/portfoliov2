...
import { stack } from "../../assets/dev/stack";
                ...
                <div className='h-96 flex flex-col items-center md:items-start justify-center'>
                    ...
                    <div className='flex flex-col-reverse md:flex-row items-center justify-between'>
                        <h1 className='text-xl md:text-6xl card'>
                            <span data-color={theme === 'light' ? 'light' : 'dark'}>Front-End</span>
                            <span data-color={theme === 'light' ? 'light' : 'dark'}>React</span>
                            <span data-color={theme === 'light' ? 'light' : 'dark'}>Developer</span>
                        </h1>
                        {/* <Avatar /> */}
                    ...
                    <h2 className='text-lg text-center md:text-left md:text-xl my-4'>Hi, I'm Manjesh Hembrom. A passionate Front-end React Developer based in Bokaro, Jharkhand. 📍</h2>
                    <div className='flex space-x-8 my-4 flex-row justify-center w-full'>
                        <div className={'cursor-pointer ' + `${theme === "light" ? 'hover:text-blue-600' : 'hover:text-[#FF0063]'}`}>
                            <FaLinkedin size={30} />
                        </div>
                        <div className={'cursor-pointer ' + `${theme === "light" ? 'hover:text-blue-600' : 'hover:text-[#FF0063]'}`}>
                            <FaGithub size={30} />
