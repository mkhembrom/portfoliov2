...
const About = () => {
  ...
  return (
    <div className={"w-full h-screen mx-auto "}>
      <div
        id="About"
        className="max-w-[800px] mx-auto w-full min-h-screen pb-16 px-4 md:px-0 flex items-center justify-center"
      >
        <div className="flex flex-col items-start justify-center md:mt-20">
          ...
          >
            <div className="flex md:w-2/3 flex-col ">
              ...
              {inView && (
                ...
                >
                  ...
                  , a passionate web developer. I specialize in creating
                  visually appealing and user-friendly websites. With expertise
                  in HTML, CSS, JavaScript, and frameworks like React, I deliver
                  innovative and seamless web solutions.
            ...
            {inView && (
              <div
                className={`flex w-[200px] my-10 md:w-1/3 border  ${
                  theme === "light"
              ...
              >
                <img
                  className={`-translate-x-2 -translate-y-2 bg-red-200 border  hover:translate-y-0 hover:translate-x-0 transition-all brightness-50 hover:brightness-100 ${
